...
public class CookieController {
    ...
    public ModelAndView readCookie(@CookieValue(value = "cookieName", required = false)Cookie cookieName, HttpServletRequest httpServletRequest){
    ...
    public String deleteCookie( HttpServletRequest httpServletRequest, HttpServletResponse response) {
