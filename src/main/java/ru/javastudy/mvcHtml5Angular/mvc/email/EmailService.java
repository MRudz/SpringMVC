        ...
        try {
            MimeMessagePreparator preparator = new MimeMessagePreparator() {
                ...
                public void prepare(MimeMessage mimeMessage) throws Exception {
                    ...
                    MimeMessageHelper message = new MimeMessageHelper(mimeMessage, true, "UTF-8"); //ENCODING IMPORTANT!
                    FileSystemResource file = new FileSystemResource(new File("C:\\coinImages\\noimage.png"));
                    message.addAttachment("Cool.png", file);
                    message.setTo(to);
